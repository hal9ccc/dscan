...
class Quake: NSManagedObject {
    ...
    @NSManaged var magnitude_str:   String
    @NSManaged var place:           String
    @NSManaged var time:            Date
    @NSManaged var type:            String
    @NSManaged var magType:         String
    @NSManaged var net:             String
    ...
    func update(from quakeProperties: QuakeProperties) throws {
        ...
        guard let newCode      = dictionary["code"]      as? String,
              ...
              let newType      = dictionary["type"]      as? String,
        ...
        print ("\(code): \(type) \(magnitude_str) \(place) magType:\(magType)")
    }
}
...
struct QuakeProperties: Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        let rawMagType   = try? values.decode(String.self, forKey: .magType)
        let rawNet       = try? values.decode(String.self, forKey: .net)
